...
(() => {
	...
	const {elements, append, createData, setData, getData, untrack} = Room;
	const {DoubleCount1, DoubleCount2, SymbolToPrimitive, ArrayManipulation, StyleExample, SuspenseExample} = SimpleExamples;
